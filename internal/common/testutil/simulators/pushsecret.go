...
// SimulatePushSecretReady creates an external-secrets PushSecret custom resource
...
// simulates the behaviour of the external-secrets operator in envtest
// environments where ESO is not running.
