...
// apiextensions, and external operator (MariaDB, ESO, cert-manager) API groups.
// The scheme is constructed once and reused across all callers (CC-0002, CC-0005).
func SharedScheme() *k8sruntime.Scheme {
	sharedSchemeOnce.Do(func() {
		...
		// External operator types for typed client access (CC-0005).
