...
// TestNeutronValidate_AutoscalingTargetNeedsAPositiveRequest pins the HPA
...
func TestNeutronValidate_AutoscalingTargetNeedsAPositiveRequest(t *testing.T) {
	g := gomega.NewWithT(t)
	w := &NeutronWebhook{}
	withTarget := func() *Neutron {
		o := validNeutron()
...
// TestNeutronValidate_AutoscalingTargetsAndBehavior pins the target and behavior
...
func TestNeutronValidate_AutoscalingTargetsAndBehavior(t *testing.T) {
	g := gomega.NewWithT(t)
	w := &NeutronWebhook{}
	with := func(a *AutoscalingSpec) *Neutron {
		o := validNeutron()
