...
func TestReconcileConfig_RendersTheConfigFiles(t *testing.T) {
	...
	g.Expect(conf).To(ContainSubstring("dns_domain = cobaltcore.local."))
	...
	g.Expect(ml2).To(ContainSubstring("extension_drivers = port_security,dns_domain_ports,tag_ports_during_bulk_creation"))
