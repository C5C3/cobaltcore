...
// TestCinderValidate_AutoscalingTargetNeedsAPositiveRequest pins the HPA
...
func TestCinderValidate_AutoscalingTargetNeedsAPositiveRequest(t *testing.T) {
	g := gomega.NewWithT(t)
	w := &CinderWebhook{}
	withTarget := func() *Cinder {
		o := validCinder()
