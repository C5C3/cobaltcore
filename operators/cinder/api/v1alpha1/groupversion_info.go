...
// +groupName=cinder.openstack.c5c3.io
...
// Package v1alpha1 contains the Cinder service API types: Cinder for the
// service itself, CinderBackend for a volume backend and CinderBackupBackend
// for a backup driver.
package v1alpha1
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "cinder.openstack.c5c3.io", Version: "v1alpha1"}
