...
FIXTURES: tuple[Fixture, ...] = (
    ...
    Fixture(
        filename="48-deployment-nodeselector-invalid-key.yaml",
        comment=(
        ...
        name="barbican-invalid-nodeselector",
        deployment=(
            "    replicas: 1\n"
            "    nodeSelector:\n"
            '      "bad key": x'
    ...
    Fixture(
        filename="49-jobs-resources-request-above-limit.yaml",
        comment=(
        ...
        name="barbican-invalid-jobs-resources",
        extra=(
            "  jobs:\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="50-deployment-toleration-empty-key-equal.yaml",
        comment=(
        ...
        name="barbican-invalid-toleration",
        deployment=(
            "    replicas: 1\n"
            "    tolerations:\n"
            "    - operator: Equal\n"
    ...
    Fixture(
        filename="51-autoscaling-cpu-request-zero.yaml",
        comment=(
        ...
        name="barbican-invalid-autoscaling-request",
        deployment=(
            "    replicas: 1\n"
            "    resources:\n"
            "      requests:\n"
