...
"""Fast unit tests for the barbican invalid-CR fixture generator.
...
# chainsaw-test.yaml.
_EXPECTED_FIXTURE_COUNT = 47


def _load_generator() -> types.ModuleType:
    spec = importlib.util.spec_from_file_location("barbican_invalid_cr_generate", _GENERATOR)
