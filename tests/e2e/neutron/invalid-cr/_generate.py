...
FIXTURES: tuple[Fixture, ...] = (
    ...
    Fixture(
        filename="15-deployment-nodeselector-invalid-key.yaml",
        comment=(
        ...
        name="neutron-invalid-nodeselector",
        extra=(
            "  deployment:\n"
            "    nodeSelector:\n"
            '      "bad key": x\n'
    ...
    Fixture(
        filename="16-jobs-resources-request-above-limit.yaml",
        comment=(
        ...
        name="neutron-invalid-jobs-resources",
        extra=(
            "  jobs:\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="17-deployment-toleration-empty-key-equal.yaml",
        comment=(
        ...
        name="neutron-invalid-toleration",
        extra=(
            "  deployment:\n"
            "    tolerations:\n"
            "    - operator: Equal\n"
    ...
    Fixture(
        filename="20-autoscaling-behavior-window-above-max.yaml",
        comment=(
        ...
        name="neutron-invalid-autoscaling-behavior",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
    ...
    Fixture(
        filename="21-autoscaling-memory-target-unreachable.yaml",
        comment=(
        ...
        name="neutron-invalid-autoscaling-memory",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
