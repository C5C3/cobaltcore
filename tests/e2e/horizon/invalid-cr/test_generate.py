...
"""Fast unit tests for the horizon invalid-CR fixture generator.

Mirrors tests/e2e/keystone/invalid-cr/test_generate.py: guards the
...
def _load_generator() -> types.ModuleType:
    spec = importlib.util.spec_from_file_location("horizon_invalid_cr_generate", _GENERATOR)
