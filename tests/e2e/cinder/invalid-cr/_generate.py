...
FIXTURES: tuple[Fixture, ...] = (
    ...
    Fixture(
        filename="19-api-deployment-nodeselector-invalid-key.yaml",
        comment=(
        ...
        name="cinder-invalid-nodeselector",
        extra=(
            "  api:\n"
            "    deployment:\n"
            "      nodeSelector:\n"
    ...
    Fixture(
        filename="20-jobs-resources-request-above-limit.yaml",
        comment=(
        ...
        name="cinder-invalid-jobs-resources",
        extra=(
            "  jobs:\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="21-api-deployment-toleration-empty-key-equal.yaml",
        comment=(
        ...
        name="cinder-invalid-toleration",
        extra=(
            "  api:\n"
            "    deployment:\n"
            "      tolerations:\n"
    ...
    Fixture(
        filename="22-autoscaling-cpu-request-zero.yaml",
        comment=(
            "spec.api.deployment.resources.requests.cpu names a CPU request of zero while\n"
        ...
        name="cinder-invalid-autoscaling-request",
        extra=(
            "  api:\n"
            "    deployment:\n"
            "      resources:\n"
    ...
    Fixture(
        filename="23-autoscaling-behavior-window-above-max.yaml",
        comment=(
        ...
        name="cinder-invalid-autoscaling-behavior",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
    ...
    Fixture(
        filename="24-autoscaling-memory-target-unreachable.yaml",
        comment=(
        ...
        name="cinder-invalid-autoscaling-memory-target",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
