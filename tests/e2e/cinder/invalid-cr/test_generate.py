...
"""Fast unit tests for the cinder invalid-CR fixture generator.

Mirrors tests/e2e/neutron/invalid-cr/test_generate.py: guards the
...
* The long-name fixture sits exactly one character past
  MaxCinderNameLength and every other fixture clears the bound.
...
_MAX_NAME_LENGTH = 43
_LONG_NAME_FIXTURE = "16-name-too-long.yaml"


def _load_generator() -> types.ModuleType:
    spec = importlib.util.spec_from_file_location("cinder_invalid_cr_generate", _GENERATOR)
...
class TestFixtures(unittest.TestCase):
    ...
    def test_scaffold_name_within_webhook_bound(self) -> None:
        """Only the long-name fixture may exceed MaxCinderNameLength (43).
        ...
        for fixture in self.generator.FIXTURES:
            ...
            self.assertLessEqual(
                len(fixture.name),
                _MAX_NAME_LENGTH,
                f"{fixture.filename} name exceeds MaxCinderNameLength",
            )
