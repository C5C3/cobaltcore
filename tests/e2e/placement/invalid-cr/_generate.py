...
FIXTURES: tuple[Fixture, ...] = (
    ...
    Fixture(
        ...
        name="placement-invalid-autoscaling-behavior",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
    ...
    Fixture(
        filename="36-deployment-nodeselector-invalid-key.yaml",
        comment=(
        ...
        name="placement-invalid-nodeselector",
        deployment=(
            "    replicas: 1\n"
            "    nodeSelector:\n"
            '      "bad key": x'
    ...
    Fixture(
        filename="37-jobs-resources-request-above-limit.yaml",
        comment=(
        ...
        name="placement-invalid-jobs-resources",
        extra=(
            "  jobs:\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="38-deployment-toleration-empty-key-equal.yaml",
        comment=(
        ...
        name="placement-invalid-toleration",
        deployment=(
            "    replicas: 1\n"
            "    tolerations:\n"
            "    - operator: Equal\n"
    ...
    Fixture(
        filename="39-autoscaling-cpu-request-zero.yaml",
        comment=(
        ...
        name="placement-invalid-autoscaling-request",
        deployment=(
            "    replicas: 1\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="40-autoscaling-memory-target-unreachable.yaml",
        comment=(
        ...
        name="placement-invalid-autoscaling-memory-target",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
