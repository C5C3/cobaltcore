...
FIXTURES: tuple[Fixture, ...] = (
    ...
    Fixture(
        filename="34-autoscaling-cpu-request-zero.yaml",
        comment=(
        ...
        name="glance-invalid-autoscaling-request",
        deployment=(
            "    replicas: 1\n"
            "    resources:\n"
            "      requests:\n"
    ...
    Fixture(
        filename="35-autoscaling-behavior-window-above-max.yaml",
        comment=(
        ...
        name="glance-invalid-autoscaling-behavior",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
    ...
    Fixture(
        filename="36-autoscaling-memory-target-unreachable.yaml",
        comment=(
        ...
        name="glance-invalid-autoscaling-memory-target",
        extra=(
            "  autoscaling:\n"
            "    minReplicas: 1\n"
            "    maxReplicas: 3\n"
