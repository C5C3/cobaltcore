...
"""Fast unit tests for the glance invalid-CR fixture generator.

Mirrors tests/e2e/horizon/invalid-cr/test_generate.py: guards the
...
# chainsaw-test.yaml.
_EXPECTED_FIXTURE_COUNT = 20


def _load_generator() -> types.ModuleType:
    spec = importlib.util.spec_from_file_location("glance_invalid_cr_generate", _GENERATOR)
