    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Attach S3 Multi-Store Backends to Glance', link: '/guides/glance-s3-multistore' },
          ...
          { text: 'Enable Glance Operator Metrics', link: '/guides/enable-glance-operator-metrics' },
          { text: 'Enable Glance Operator NetworkPolicy', link: '/guides/enable-glance-operator-networkpolicy' },
